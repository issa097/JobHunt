...
<div class="py-10 relative bg-white sm:py-16 lg:py-24 lg:pt-36">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 text-center  ">
        ...
        <p class="mt-10 text-base text-center text-[#3B564D] md:mt-20 p-6 py-3 border w-72 border-[#3B564D] rounded-full mx-auto">
